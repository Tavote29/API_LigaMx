...
public class EstadisticasServiceImpl implements IEstadisticasService {
    ...
    public List<getTablaPosiciones> obtenerTablaPosiciones(Long id) {
        ...
        if (tablaPosiciones == null) throw new RuntimeException("Error en el servidor");
    ...
    public List<getTablaGoleoIndividual> obtenerTablaGoleo(Long id) {
        ...
        if (tablaGoleo == null) throw new RuntimeException("Error en el servidor");
        return tablaGoleo;
    }
    ...
    public List<getTablaCociente> obtenerTablaCociente() {
        ...
        if(tablaCociente == null) throw new RuntimeException(("Error en el servidor"));
    ...
    public List<getMarcadorPartido> obtenerTablaOfensiva(Long id) {
        ...
        if (tablaOfensiva == null) throw new RuntimeException("Error en el servidor");
    ...
    public List<getMarcadorPartido> obtenerTablaDefensiva(Long id) {
        ...
        if (tablaDefensiva == null) throw new RuntimeException("Error en el servidor");
