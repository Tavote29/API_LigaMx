...
public interface EstadisticasRepository extends JpaRepository < Torneo,Long > {
    ...
    @NativeQuery(value = TABLA_POSICIONES) List < getTablaPosiciones > obtenerTablaPosiciones(@Param("id") Long id);

    @NativeQuery(value = TABLA_GOLEO_INDIVIDUAL) List < getTablaGoleoIndividual > obtenerTablaGoleo(@Param("id") Long id);

    @NativeQuery(value = TABLA_COCIENTE) List < getTablaCociente > obtenerTablaCociente();

    @NativeQuery(value = TABLA_OFENSIVA) List < getMarcadorPartido > obtenerTablaOfensiva(@Param("id") Long id);

    @NativeQuery(value = TABLA_DEFENSIVA) List < getMarcadorPartido > obtenerTablaDefensiva(@Param("id") Long id);
